...
public final class Constants {
  ...
  public static final double kLatency = 0.15; // Latency for shooting on the move
  public static final double kMagnusK = 0.0; // Adjust for Magnus affect—requires tuning!!
