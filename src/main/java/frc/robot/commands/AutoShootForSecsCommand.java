...
public class AutoShootForSecsCommand extends Command {
  ...
  // Constructor
  public AutoShootForSecsCommand(ShootSubsystem shootSubsystem, double seconds) {
  ...
  public void execute() {
    ...
    if(m_timer.get() < m_seconds) {
      m_shootSubsystem.shoot(ShootConstants.k_autoHubShotSpeed);
    }
  }
